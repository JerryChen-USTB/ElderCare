...
export default {
  data() {
    return {
      faqs: [
        {
          question: "如何使用智能聊天帮我操作软件?",
          answer: "点击首页的【智能聊天】，直接输入您想要做的事情，聊天助手小乐会帮您处理。或者您可以输入问题'如何使用远程协助?'，即可获取操作步骤。"
        },
        {
          question: "紧急求助功能如何使用?",
          answer: "点击【一键救助】按钮，会立即向紧急联系人发送求助信息，同时为您跳转到120拨号页面，同时您可以参考页面上提供的位置信息描述，向接线员描述您的准确位置。"
        },
        {
          question: "使用远程协助会收费吗？",
          answer: "不会，远程协助功能目前是免费提供的，您可以放心使用。"
        }
      ],
